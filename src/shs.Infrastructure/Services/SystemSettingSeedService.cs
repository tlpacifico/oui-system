...
public class SystemSettingSeedService
{
    ...
    public async Task SeedAsync()
    {
        ...
        var defaults = new List<(string Key, string Value, string ValueType, string Module, string DisplayName, string? Description)>
        {
            ...
            ("pos.auto_create_settlement", "false", "bool", "pos", "Criação automática de settlement após venda", "Quando ativo, cria automaticamente um acerto já finalizado após cada venda, emitindo de imediato o crédito em loja ao fornecedor"),
