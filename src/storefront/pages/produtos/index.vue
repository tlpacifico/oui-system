...
<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <h1 class="text-2xl font-normal text-gray-900 mb-6">Produtos</h1>

    <!-- Filters -->
    <div class="bg-white rounded-lg border border-cream-dark p-4 mb-6">
      <div class="flex flex-wrap gap-3 items-end">
        <div class="flex-1 min-w-[200px]">
          ...
          <input
            ...
            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sage"
        ...
        <div class="w-40">
          ...
          <select v-model="brand" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sage" @change="applyFilters">
        ...
        <div class="w-40">
          ...
          <select v-model="category" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sage" @change="applyFilters">
            <option value="">Todas</option>
        ...
        <div class="w-28">
          ...
          <select v-model="size" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sage" @change="applyFilters">
        ...
        <div class="w-36">
          ...
          <select v-model="sort" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-sage" @change="applyFilters">
        ...
        <button
          class="px-4 py-2 bg-sage text-white text-sm rounded-lg hover:bg-sage-dark transition"
          @click="applyFilters"
        >
          Filtrar
        </button>
    ...
    <div v-else-if="products?.items?.length" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      <NuxtLink
        ...
        class="group bg-white rounded-lg border border-cream-dark overflow-hidden hover:shadow-md transition"
      >
        ...
        <div class="p-3">
          <h3 class="text-sm font-medium text-gray-900 group-hover:text-sage-dark transition truncate font-sans">{{ product.title }}</h3>
